...
namespace 
{
       struct add:public FunctionPass
       {
          static char ID;
          add():FunctionPass(ID){}
                ...
                if((inst->getOpcode() == Instruction::Add)||(inst->getOpcode() == Instruction::FAdd))
                   {
                  	 ...
                  	 if((a1->getOpcode() == Instruction::Load || b1->getOpcode() == Instruction::Load) || (a1->getOpcode() == Instruction::Load || b1->getOpcode() == Instruction::Add) || (a1->getOpcode() == Instruction::Load || b1->getOpcode() == Instruction::Mul)|| (a1->getOpcode() == Instruction::Add || b1->getOpcode() == Instruction::Load) || (a1->getOpcode() == Instruction::Load) )
                  	   {
  ...
  char add::ID = 0;
  static RegisterPass<add> X("add", "this is a pass");
